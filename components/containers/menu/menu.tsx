          ...
          <div className="grid grid-cols-3 gap-10">
            ...
            <Link href="/">
              <div className="w-20 h-20">
                ...
                />
                <h1 className="mt-2 text-center">Inicio</h1>
              </div>
            ...
            <Link href="" onClick={() => signIn()} title="Ingresar">
              <div>
                ...
                <h1 className="mt-2 text-center">Ingresar</h1>
              </div>
            </Link>
            {/* Contactar */}
            <Link href="/contact" title="Contactar">
              <div>
                ...
                <h1 className="mt-2 text-center">Contactar</h1>
              </div>
            </Link>
            {/* Novedades */}
            <Link href="/Novedades" title="Nuestro Futuro">
              ...
              <h1 className="mt-2 text-center">Novedades</h1>
            </Link>
            {/* Theme */}
            <div>
              {/* Themes */}
              <Theme />
              <h1 className="mt-2 text-center">Theme</h1>
            </div>
            {/* Minimizar */}
            <div onClick={toggleMenu} className="cursor-pointer">
              ...
              <h1 className="mt-2 text-center">Ocultar</h1>
            </div>
          </div>
        </div>
      )}
